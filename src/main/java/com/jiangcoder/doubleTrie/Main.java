...
public class Main
{
    ...
    {
        BufferedReader reader = new BufferedReader(new FileReader("/root/workspace_t3/Algorithm/src/main/java/com/jiangcoder/doubleTrie/small.dic"));
        String line;
...
//        }
        ...
        List<Integer> integerList = dat.commonPrefixSearch("一举");
